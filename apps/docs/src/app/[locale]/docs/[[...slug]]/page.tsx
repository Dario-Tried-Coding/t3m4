...
import { ChevronDown, Copy, ExternalLink, Search } from 'fumadocs-ui/internal/icons'
import { DocsBody, DocsDescription, DocsPage, DocsTitle } from 'fumadocs-ui/page'
import { Locale } from 'next-intl'
import { draftMode } from 'next/headers'

type test = RichTextTocNode
  ...
  return (
    ...
    >
      {async ([{ docs }]) => {
        ...
        // return <pre>{JSON.stringify(buildToc(docs.item?.body.json.toc ?? []), null, 2)}</pre>
        ...
        return (
          <DocsPage toc={toc}>
            ...
            <div className="flex gap-2">
              ...
              <Popover>
                <PopoverTrigger disabled className={cn(buttonVariants({ color: 'secondary', size: 'sm', className: 'gap-2' }))}>
                  Open
