...
export namespace State {
  ...
  export type AsMap = Map<string, T_Island.AsMap>
  export namespace AsMap {
    export type Island = T_Island.AsMap
    export namespace Island {
      export type Facets = T_Island.AsMap.Facets
      export namespace Facets {
        export type Facet = T_Island.AsMap.Facets.Facet
      }

      export type Mode = T_Island.AsMap.Mode
      export namespace Mode {
        export type Facet = T_Island.AsMap.Mode.Facet
      }
    }
  }
}
